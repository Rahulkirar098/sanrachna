...
import dite from '../../../../Assets/Image/static/dite.jpg'
                        ...
                        return (
                            ...
                            >
                                <View style={styles.screenView}>
                                    <Image source={dite} style={{ width: '100%', height: '100%' }} resizeMode='cover' />
                                </View>
                                <Text style={styles.primaryText}>Diet Plan - Week 1</Text>
                            </TouchableOpacity>
                        )
                    }}
                />
